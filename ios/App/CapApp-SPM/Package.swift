...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityBackgroundGeolocation", path: "../../../node_modules/.pnpm/@capacitor-community+background-geolocation@1.2.26_patch_hash=66512890bc7486820f2479bd3_20cb47a21e87b9bcd06ec7e1e075a19e/node_modules/@capacitor-community/background-geolocation"),
        ...
        .package(name: "CapacitorSecureStoragePlugin", path: "../../../node_modules/.pnpm/capacitor-secure-storage-plugin@0.13.0_@capacitor+core@8.3.4/node_modules/capacitor-secure-storage-plugin")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
